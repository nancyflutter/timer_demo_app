...
class TimerControllerWithDotePointerTwo extends GetxController with GetSingleTickerProviderStateMixin {
  // final ValueNotifier<RxDouble> valueNotifier = ValueNotifier(RxDouble(0));
  ...
  RxString countText = RxString("00:10:00");
  RxString str = RxString("");

  RxDouble progress = RxDouble(1.0);

  RxBool isLoaderShow = RxBool(false);
